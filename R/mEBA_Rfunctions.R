# duplicate function in EBA_functions
...
### ----------------------------------------------------------------------------
# ### commenting for now since it's not a R function ---------------------------
# #ggplot settings
# hw <- theme_gray()+ theme(
...
#' function to detrend, standardize, and filter out low frequencies (below 1 Hz)
#'
#' @param sgnl restOfOwl
#' @param dsfrq restOfOwl
#' @param channels restOfOwl
#'
#' @return
#' @noRd
...
#' function to simulate meba data for 5 different settings
#'
#' @param t restOfOwl
#'
#' @return restOfOwl
